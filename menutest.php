	...
	<div class="navbar-inner">
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
               ...
               <?php
                  	$sql="SELECT * FROM tbl_dmsp";
                  $sql_danhmucsp=mysqli_query($conn,$sql);
                  while ($sql_danhmuc=mysqli_fetch_array($sql_danhmucsp)) 
                  {
                ?>
                    <option><?php   echo $sql_danhmuc['DMSP_name'] ?></option>
                <?php } ?>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto text-center mr-xl-5">
									...
									<div class="row">
										<div class="col-sm-6 multi-gd-img">
											<ul class="multi-column-dropdown">
												...
												<li>
													<a hAAref="product.html">All Mobile Phones</a>
												</li>
												<li>
						...
						<?php 
							$sql_danhmuc_menu=mysqli_query($conn,"SELECT * FROM tbl_dmsp");
							while ($row_menu=mysqli_fetch_array($sql_danhmuc_menu))
							{
								
							
						 ?>
						<li class="nav-item mr-lg-2 mb-lg-0 mb-2">
							<a class="nav-link" href="chitietsp.php"><?php echo $row_menu["DMSP_name"]  ?></a>
						</li>
					<?php  } ?>
